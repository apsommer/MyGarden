...
This is an example Android app that is a simple game to add plants to your garden and keep them alive by watering them on time, created as part of the [Android Developer Nanodegree by Google](https://www.udacity.com/course/android-developer-nanodegree-by-google--nd801). The app illustrates the power of widgets and collection widgets by making it easier for the user to monitor and water their plants from the home screen.
